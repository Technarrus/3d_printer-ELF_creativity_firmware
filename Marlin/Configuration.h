 ...
 */
#define CONFIGURATION_H_VERSION 130121
...
#define STRING_CONFIG_H_AUTHOR "(FlyingbearGhost5)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "THE ELF"
