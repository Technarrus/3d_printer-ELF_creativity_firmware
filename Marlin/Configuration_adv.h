...
//
#define NUM_Z_STEPPER_DRIVERS 2   // (1-4) Z options change based on how many //ВКЛ

#if NUM_Z_STEPPER_DRIVERS > 1
  #define Z_MULTI_ENDSTOPS //ВКЛ
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define ADVANCED_PAUSE_PURGE_LENGTH         1  // (mm) Length to extrude after loading.
  ...
  #define FILAMENT_CHANGE_ALERT_BEEPS         12  // Number of alert beeps to play when a response is needed.
